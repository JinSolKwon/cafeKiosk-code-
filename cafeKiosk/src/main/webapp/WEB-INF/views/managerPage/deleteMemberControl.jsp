...
<body>
	...
	<div id="manageMain">
		...
		<form action="<c:url value="#"/>" method="POST" style="margin-left:65%">
		...
		<form action="<c:url value="#"/>" method="POST">
			<input type="submit" class="btn btn-secondary" value="삭제" style="height:40px;width:70px;float:right;"
				formaction="#">
			<input type="submit" class="btn btn-secondary" value="복구" style="margin-right:10px;height:40px;width:70px;float:right;"
				formaction="#">
			<table class="table">
				<thead>
