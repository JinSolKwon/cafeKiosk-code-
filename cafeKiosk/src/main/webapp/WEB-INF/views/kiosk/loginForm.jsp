...
<body>
	<div class="container-main">
		<div class="header-main">
			<a href="<c:url value="/kiosk/main" />"><img alt="cafeCarp"
				src="<c:url value="/resources/img/cafeCarp_main.png" />"></a>
		</div>
		<div class="main-login">
			<form action="<c:url value="/kiosk/login" />" method="post">
				<!-- 	<input size="50" type="text" id="phone" name="phone" oninput="autoHyphen(this)" maxlength="13" placeholder="'-'를 제외한 숫자 11자리 입력"/> -->
				<input size="50" type="text" id="phone" name="phone" maxlength="13"
					placeholder="'-'를 제외한 숫자 11자리 입력" />
