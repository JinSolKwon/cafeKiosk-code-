		...
		<table id="table-receipePrint">
			<thead>
				<tr class="th-receipePrint">
					<td class="th-receipePrint1" colspan="3" >상&nbsp;&nbsp;&nbsp;&nbsp;품&nbsp;&nbsp;&nbsp;&nbsp;명</td><td class="th-receipePrint1">수량</td><td class="th-receipePrint1">금&nbsp;&nbsp;액</td>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${sessionScope.resultReceipe}" var="receipeOne" varStatus="status">
					<tr class="tr-receipePrint1">
						<td class="td-receipePrint1-1"><span><c:if test="${not empty receipeOne.getTemperature()}">${receipeOne.getTemperature()}</c:if></span></td>
