...
<body>
	<div class="contain">
		<header class="d-flex flex-wrap">
			...
			<span class="mb-3 mb-md-0 me-md-auto fs-3" id="identity">Master</span>

				<ul class="nav nav-pills">
					<li id="menu"><button class="btn btn-primary" id="btn"
							onclick="location.href='<c:url value="#"/>'">주문하기</button></li>
					<li id="menu"><button class="btn btn-primary" id="btn"
							onclick="location.href='<c:url value="#"/>'">관리자페이지</button></li>
					<li id="menu"><button class="btn btn-primary" id="btn"
